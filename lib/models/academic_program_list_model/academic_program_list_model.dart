...
class AcademicProgramListModel {
  int? tranId;
  String? title;
  int? orderNo;
  String? description;
  ...
  factory AcademicProgramListModel.fromMap(Map<String, dynamic> data) {
    return AcademicProgramListModel(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [AcademicProgramListModel].
  factory AcademicProgramListModel.fromJson(String data) {
    return AcademicProgramListModel.fromMap(
        json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [AcademicProgramListModel] to a JSON string.
  String toJson() => json.encode(toMap());

  AcademicProgramListModel copyWith({
    int? tranId,
    String? title,
    int? orderNo,
    String? description,
