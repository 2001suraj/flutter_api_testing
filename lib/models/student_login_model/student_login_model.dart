...
class StudentLoginModel {
  ...
  factory StudentLoginModel.fromMap(Map<String, dynamic> data) {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [StudentLoginModel].
  factory StudentLoginModel.fromJson(String data) {
    return StudentLoginModel.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [StudentLoginModel] to a JSON string.
  String toJson() => json.encode(toMap());

  StudentLoginModel copyWith({
    String? accessToken,
    String? tokenType,
    int? expiresIn,
    String? refreshToken,
